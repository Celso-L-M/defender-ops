...
const CorrelatedIncident = Record({
  ...
  "sourceIp": Opt(Text),
  "sourceProviders": Vec(ProviderType),
...
const AwsCredentials = Record({
  "externalId": Opt(Text),
  "roleArn": Text,
  "regions": Vec(Text)
});
const AzureCredentials = Record({
  "clientId": Text,
  "subscriptionIds": Vec(Text),
  "tenantId": Text,
  "clientSecret": Text
});
const GcpCredentials = Record({
...
Service({
  ...
  "enrichAlertPublic": Func([Text, Text], [Result_1], []),
  ...
  "getComplianceStatus": Func(
    [ComplianceFramework, Opt(ProviderType)],
    [
      Record({
        "total": Nat,
        "failing": Nat,
  ...
  "saveAwsCredentials": Func([AwsCredentials], [], []),
  "saveAzureCredentials": Func([AzureCredentials], [], []),
  ...
  "saveGcpCredentials": Func([GcpCredentials], [], []),
  ...
  "seedMockAlertsAndRunCorrelation": Func(
    [],
    [Vec(CorrelatedIncident)],
    []
  ),
  "setPollingInterval": Func([ProviderType, PollingInterval], [], []),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Result_12 = IDL2.Variant({ "ok": IDL2.Text, "err": IDL2.Text });
  ...
  const AwsCredentials2 = IDL2.Record({
    "externalId": IDL2.Opt(IDL2.Text),
    "roleArn": IDL2.Text,
    "regions": IDL2.Vec(IDL2.Text)
  });
  const AzureCredentials2 = IDL2.Record({
    "clientId": IDL2.Text,
    "subscriptionIds": IDL2.Vec(IDL2.Text),
    "tenantId": IDL2.Text,
    "clientSecret": IDL2.Text
  });
  const GcpCredentials2 = IDL2.Record({
    "serviceAccountJson": IDL2.Text,
  ...
  return IDL2.Service({
    ...
    "enrichAlertPublic": IDL2.Func([IDL2.Text, IDL2.Text], [Result_12], []),
    ...
    "saveAwsCredentials": IDL2.Func([AwsCredentials2], [], []),
    "saveAzureCredentials": IDL2.Func([AzureCredentials2], [], []),
    ...
    "saveGcpCredentials": IDL2.Func([GcpCredentials2], [], []),
    ...
    "seedMockAlertsAndRunCorrelation": IDL2.Func(
      [],
      [IDL2.Vec(CorrelatedIncident2)],
      []
    ),
...
class Backend {
  ...
  async blockIp(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.blockIp(to_candid_record_n1(this._uploadFile, this._downloadFile, arg0));
  ...
  async exportComplianceCsv(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.exportComplianceCsv(to_candid_ComplianceFramework_n14(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async exportCompliancePdf(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.exportCompliancePdf(to_candid_ComplianceFramework_n14(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getAssets(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getAssets(to_candid_record_n50(this._uploadFile, this._downloadFile, arg0));
  ...
  async getComplianceControlGaps(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getComplianceControlGaps(to_candid_ComplianceFramework_n14(this._uploadFile, this._downloadFile, arg0));
  ...
  async getComplianceStatus(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.getComplianceStatus(to_candid_ComplianceFramework_n14(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n61(this._uploadFile, this._downloadFile, arg1));
  ...
  async getComplianceTrend(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getComplianceTrend(to_candid_ComplianceFramework_n14(this._uploadFile, this._downloadFile, arg0));
  ...
  async getFailedIngestions(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.getFailedIngestions(to_candid_opt_n61(this._uploadFile, this._downloadFile, arg0), arg1);
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getIngestionStats() {
    if (this.processError) {
      try {
        ...
        return from_candid_IngestionStats_n80(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async getNormalizedAlerts(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getNormalizedAlerts(to_candid_record_n89(this._uploadFile, this._downloadFile, arg0));
        return from_candid_vec_n44(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async getRawFindings(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.getRawFindings(to_candid_ProviderType_n3(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
        return from_candid_record_n99(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async http_request(arg0) {
    if (this.processError) {
      try {
        ...
        return from_candid_record_n114(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async isolateResource(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.isolateResource(to_candid_record_n117(this._uploadFile, this._downloadFile, arg0));
        return from_candid_PlaybookResult_n5(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async revokeIamCredentials(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.revokeIamCredentials(to_candid_record_n118(this._uploadFile, this._downloadFile, arg0));
        return from_candid_PlaybookResult_n5(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async saveAlertRule(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.saveAlertRule(to_candid_AlertRule_n119(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async saveAwsCredentials(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.saveAwsCredentials(to_candid_AwsCredentials_n126(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async saveAzureCredentials(arg0) {
    if (this.processError) {
      try {
  ...
  async saveEnrichmentKeys(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.saveEnrichmentKeys(to_candid_record_n128(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async seedMockAlertsAndRunCorrelation() {
    if (this.processError) {
      try {
  ...
  async setPollingInterval(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.setPollingInterval(to_candid_ProviderType_n3(this._uploadFile, this._downloadFile, arg0), to_candid_PollingInterval_n130(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async testAwsConnection() {
    if (this.processError) {
      try {
        ...
        return from_candid_ConnectionTestResult_n132(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async triggerPoll(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.triggerPoll(to_candid_ProviderType_n3(this._uploadFile, this._downloadFile, arg0));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateAlertStatus(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.updateAlertStatus(arg0, to_candid_AlertStatus_n90(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n134(this._uploadFile, this._downloadFile, arg2));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async updateCorrelatedIncidentStatus(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
        const result = await this.actor.updateCorrelatedIncidentStatus(arg0, to_candid_IncidentStatus_n135(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n134(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n134(this._uploadFile, this._downloadFile, arg3));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_AlertEnrichment_n29(_uploadFile, _downloadFile, value) {
  return from_candid_record_n30(_uploadFile, _downloadFile, value);
}
function from_candid_AlertRule_n35(_uploadFile, _downloadFile, value) {
  return from_candid_record_n36(_uploadFile, _downloadFile, value);
}
function from_candid_AlertStatus_n21(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n22(_uploadFile, _downloadFile, value);
}
function from_candid_AssetType_n48(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n49(_uploadFile, _downloadFile, value);
}
function from_candid_Asset_n46(_uploadFile, _downloadFile, value) {
  return from_candid_record_n47(_uploadFile, _downloadFile, value);
}
function from_candid_ComplianceControl_n55(_uploadFile, _downloadFile, value) {
  return from_candid_record_n56(_uploadFile, _downloadFile, value);
}
function from_candid_ComplianceFramework_n59(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n60(_uploadFile, _downloadFile, value);
}
function from_candid_ComplianceTrendEntry_n64(_uploadFile, _downloadFile, value) {
  return from_candid_record_n65(_uploadFile, _downloadFile, value);
}
function from_candid_ConnectionTestResult_n132(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n133(_uploadFile, _downloadFile, value);
}
function from_candid_ControlStatus_n57(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n58(_uploadFile, _downloadFile, value);
}
function from_candid_CorrelatedIncident_n67(_uploadFile, _downloadFile, value) {
  return from_candid_record_n68(_uploadFile, _downloadFile, value);
}
function from_candid_CredentialHealthStatus_n75(_uploadFile, _downloadFile, value) {
  return from_candid_record_n76(_uploadFile, _downloadFile, value);
}
function from_candid_CredentialHealth_n78(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n79(_uploadFile, _downloadFile, value);
}
function from_candid_GeneratedReport_n104(_uploadFile, _downloadFile, value) {
...
function from_candid_IngestionStats_n80(_uploadFile, _downloadFile, value) {
  return from_candid_record_n81(_uploadFile, _downloadFile, value);
}
function from_candid_NormalizedAlert_n19(_uploadFile, _downloadFile, value) {
  return from_candid_record_n20(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationChannel_n42(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n43(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationLog_n95(_uploadFile, _downloadFile, value) {
  return from_candid_record_n96(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationStatus_n97(_uploadFile, _downloadFile, value) {
...
function from_candid_PollingInterval_n87(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n88(_uploadFile, _downloadFile, value);
}
function from_candid_PollingStatus_n85(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n86(_uploadFile, _downloadFile, value);
}
function from_candid_ProviderPollingState_n83(_uploadFile, _downloadFile, value) {
...
function from_candid_RawFinding_n101(_uploadFile, _downloadFile, value) {
  return from_candid_record_n102(_uploadFile, _downloadFile, value);
}
function from_candid_Result_1_n11(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function from_candid_Result_n16(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_RuleSeverityThreshold_n38(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n39(_uploadFile, _downloadFile, value);
}
function from_candid_SearchResult_n112(_uploadFile, _downloadFile, value) {
  return from_candid_record_n113(_uploadFile, _downloadFile, value);
}
function from_candid_Severity_n26(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n27(_uploadFile, _downloadFile, value);
}
function from_candid_TimelineEvent_n107(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n109(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_Severity_n26(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n18(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_NormalizedAlert_n19(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n23(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : value[0];
}
function from_candid_opt_n24(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_variant_n25(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n28(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_AlertEnrichment_n29(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n37(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_RuleSeverityThreshold_n38(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n40(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : value[0];
}
function from_candid_opt_n45(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_Asset_n46(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n66(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_CorrelatedIncident_n67(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n108(_uploadFile, _downloadFile, value) {
  return {
    ...
    description: value.description,
    timestamp: value.timestamp,
    severity: record_opt_to_undefined(from_candid_opt_n109(_uploadFile, _downloadFile, value.severity)),
...
function from_candid_record_n110(_uploadFile, _downloadFile, value) {
  return {
    ...
    results: from_candid_vec_n111(_uploadFile, _downloadFile, value.results)
  };
}
...
function from_candid_record_n114(_uploadFile, _downloadFile, value) {
  return {
    ...
    upgrade: record_opt_to_undefined(from_candid_opt_n115(_uploadFile, _downloadFile, value.upgrade)),
    streaming_strategy: record_opt_to_undefined(from_candid_opt_n116(_uploadFile, _downloadFile, value.streaming_strategy)),
...
function from_candid_record_n20(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    region: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.region)),
    status: from_candid_AlertStatus_n21(_uploadFile, _downloadFile, value.status),
    mitre: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.mitre)),
    title: value.title,
    findingId: value.findingId,
    provider: from_candid_ProviderType_n9(_uploadFile, _downloadFile, value.provider),
    accountId: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.accountId)),
    ...
    description: value.description,
    ingestionSource: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.ingestionSource)),
    ...
    severity: from_candid_Severity_n26(_uploadFile, _downloadFile, value.severity),
    enrichment: record_opt_to_undefined(from_candid_opt_n28(_uploadFile, _downloadFile, value.enrichment))
  };
}
function from_candid_record_n30(_uploadFile, _downloadFile, value) {
  return {
    domainRep: record_opt_to_undefined(from_candid_opt_n31(_uploadFile, _downloadFile, value.domainRep)),
    knownMaliciousIp: value.knownMaliciousIp,
    ipReputation: record_opt_to_undefined(from_candid_opt_n32(_uploadFile, _downloadFile, value.ipReputation)),
    enrichedAt: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.enrichedAt)),
    mitreDetail: record_opt_to_undefined(from_candid_opt_n33(_uploadFile, _downloadFile, value.mitreDetail))
  };
}
function from_candid_record_n36(_uploadFile, _downloadFile, value) {
  return {
    ...
    severityThreshold: record_opt_to_undefined(from_candid_opt_n37(_uploadFile, _downloadFile, value.severityThreshold)),
    provider: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.provider)),
    customer: value.customer,
    assetId: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.assetId)),
    name: value.name,
    escalationMinutes: record_opt_to_undefined(from_candid_opt_n40(_uploadFile, _downloadFile, value.escalationMinutes)),
    channels: from_candid_vec_n41(_uploadFile, _downloadFile, value.channels),
...
function from_candid_record_n47(_uploadFile, _downloadFile, value) {
  return {
    ...
    name: value.name,
    tags: value.tags,
    assetType: from_candid_AssetType_n48(_uploadFile, _downloadFile, value.assetType),
...
function from_candid_record_n56(_uploadFile, _downloadFile, value) {
  return {
    status: from_candid_ControlStatus_n57(_uploadFile, _downloadFile, value.status),
    title: value.title,
    provider: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.provider)),
    framework: from_candid_ComplianceFramework_n59(_uploadFile, _downloadFile, value.framework),
...
function from_candid_record_n62(_uploadFile, _downloadFile, value) {
  return {
    ...
    controls: from_candid_vec_n54(_uploadFile, _downloadFile, value.controls),
    score: value.score,
...
function from_candid_record_n68(_uploadFile, _downloadFile, value) {
  return {
    ...
    sourceProviders: from_candid_vec_n71(_uploadFile, _downloadFile, value.sourceProviders),
...
function from_candid_record_n76(_uploadFile, _downloadFile, value) {
  return {
    ...
    expiryNs: record_opt_to_undefined(from_candid_opt_n77(_uploadFile, _downloadFile, value.expiryNs)),
    health: from_candid_CredentialHealth_n78(_uploadFile, _downloadFile, value.health)
  };
}
function from_candid_record_n81(_uploadFile, _downloadFile, value) {
  return {
    providerStates: from_candid_vec_n82(_uploadFile, _downloadFile, value.providerStates),
...
function from_candid_record_n84(_uploadFile, _downloadFile, value) {
  return {
    status: from_candid_PollingStatus_n85(_uploadFile, _downloadFile, value.status),
    provider: from_candid_ProviderType_n9(_uploadFile, _downloadFile, value.provider),
    interval: from_candid_PollingInterval_n87(_uploadFile, _downloadFile, value.interval),
    lastPollAttempt: record_opt_to_undefined(from_candid_opt_n77(_uploadFile, _downloadFile, value.lastPollAttempt)),
    lastSuccessfulPoll: record_opt_to_undefined(from_candid_opt_n77(_uploadFile, _downloadFile, value.lastSuccessfulPoll)),
...
function from_candid_record_n96(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_NotificationStatus_n97(_uploadFile, _downloadFile, value.status),
    acknowledgedAt: record_opt_to_undefined(from_candid_opt_n77(_uploadFile, _downloadFile, value.acknowledgedAt)),
    customer: value.customer,
    ruleId: value.ruleId,
    ...
    timestamp: value.timestamp,
    channel: from_candid_NotificationChannel_n42(_uploadFile, _downloadFile, value.channel)
  };
}
function from_candid_record_n99(_uploadFile, _downloadFile, value) {
  return {
    ...
    items: from_candid_vec_n100(_uploadFile, _downloadFile, value.items)
  };
}
function from_candid_tuple_n73(_uploadFile, _downloadFile, value) {
  return [
    value[0],
    from_candid_CorrelatedIncident_n67(_uploadFile, _downloadFile, value[1])
  ];
}
...
function from_candid_vec_n100(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_RawFinding_n101(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n103(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_GeneratedReport_n104(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n106(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_TimelineEvent_n107(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n111(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_SearchResult_n112(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n129(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_CorrelatedIncident_n67(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n34(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_AlertRule_n35(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n41(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_NotificationChannel_n42(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n44(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_NormalizedAlert_n19(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n53(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_Asset_n46(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n54(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_ComplianceControl_n55(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n63(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_ComplianceTrendEntry_n64(_uploadFile, _downloadFile, x));
}
...
function from_candid_vec_n74(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_CredentialHealthStatus_n75(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n82(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_ProviderPollingState_n83(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n94(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_NotificationLog_n95(_uploadFile, _downloadFile, x));
}
function to_candid_AlertRule_n119(_uploadFile, _downloadFile, value) {
  return to_candid_record_n120(_uploadFile, _downloadFile, value);
}
function to_candid_AlertStatus_n90(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n91(_uploadFile, _downloadFile, value);
}
function to_candid_AssetType_n51(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n52(_uploadFile, _downloadFile, value);
}
function to_candid_AwsCredentials_n126(_uploadFile, _downloadFile, value) {
  return to_candid_record_n127(_uploadFile, _downloadFile, value);
}
function to_candid_ComplianceFramework_n14(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function to_candid_IncidentStatus_n135(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n136(_uploadFile, _downloadFile, value);
}
function to_candid_NotificationChannel_n124(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n125(_uploadFile, _downloadFile, value);
}
function to_candid_PollingInterval_n130(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n131(_uploadFile, _downloadFile, value);
}
function to_candid_ProviderType_n3(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n4(_uploadFile, _downloadFile, value);
}
function to_candid_RuleSeverityThreshold_n121(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n122(_uploadFile, _downloadFile, value);
}
function to_candid_Severity_n92(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n93(_uploadFile, _downloadFile, value);
}
function to_candid_opt_n134(_uploadFile, _downloadFile, value) {
  return value === null ? candid_none() : candid_some(value);
}
function to_candid_opt_n61(_uploadFile, _downloadFile, value) {
  return value === null ? candid_none() : candid_some(to_candid_ProviderType_n3(_uploadFile, _downloadFile, value));
}
function to_candid_record_n1(_uploadFile, _downloadFile, value) {
  return {
    ip: value.ip,
    customer: value.customer,
    providers: to_candid_vec_n2(_uploadFile, _downloadFile, value.providers),
    dryRun: value.dryRun
  };
}
function to_candid_record_n117(_uploadFile, _downloadFile, value) {
  return {
    provider: to_candid_ProviderType_n3(_uploadFile, _downloadFile, value.provider),
    customer: value.customer,
...
function to_candid_record_n120(_uploadFile, _downloadFile, value) {
  return {
    ...
    severityThreshold: value.severityThreshold ? candid_some(to_candid_RuleSeverityThreshold_n121(_uploadFile, _downloadFile, value.severityThreshold)) : candid_none(),
    provider: value.provider ? candid_some(to_candid_ProviderType_n3(_uploadFile, _downloadFile, value.provider)) : candid_none(),
    customer: value.customer,
    ...
    channels: to_candid_vec_n123(_uploadFile, _downloadFile, value.channels),
    cooldownMinutes: value.cooldownMinutes,
    enabled: value.enabled,
    findingType: value.findingType ? candid_some(value.findingType) : candid_none()
  };
}
function to_candid_record_n127(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n50(_uploadFile, _downloadFile, value) {
  return {
    ...
    customer: value.customer,
    limit: value.limit,
    assetType: value.assetType ? candid_some(to_candid_AssetType_n51(_uploadFile, _downloadFile, value.assetType)) : candid_none()
  };
}
function to_candid_record_n89(_uploadFile, _downloadFile, value) {
  return {
    status: value.status ? candid_some(to_candid_AlertStatus_n90(_uploadFile, _downloadFile, value.status)) : candid_none(),
    provider: value.provider ? candid_some(to_candid_ProviderType_n3(_uploadFile, _downloadFile, value.provider)) : candid_none(),
    customer: value.customer,
    limit: value.limit,
    severity: value.severity ? candid_some(to_candid_Severity_n92(_uploadFile, _downloadFile, value.severity)) : candid_none()
  };
}
...
function to_candid_vec_n123(_uploadFile, _downloadFile, value) {
  return value.map((x) => to_candid_NotificationChannel_n124(_uploadFile, _downloadFile, x));
}
function to_candid_vec_n2(_uploadFile, _downloadFile, value) {
  return value.map((x) => to_candid_ProviderType_n3(_uploadFile, _downloadFile, x));
}
...
function useSaveAwsCredentials() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return raw.map((item) => ({
        ...
        health: (() => {
          const h = item.health;
          if (h.__kind__ === "Valid") return { __kind__: "Valid" };
          if (h.__kind__ === "Authenticating")
            return { __kind__: "Authenticating" };
          if (h.__kind__ === "ExpiringSoon")
            return {
              __kind__: "ExpiringSoon",
              _0: h.ExpiringSoon ?? ""
            };
          if (h.__kind__ === "Expired") return { __kind__: "Expired" };
          return { __kind__: "Error", _0: h.Error ?? "Unknown error" };
        })()
      }));
    },
    enabled: !!actor && !isFetching,
...
function useSaveAzureCredentials() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (creds) => {
...
function useSaveGcpCredentials() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (creds) => {
...
function useTestConnection(provider) {
  const { actor } = useActor(createActor);
  return useMutation({
    mutationFn: async () => {
      if (!actor) throw new Error("Actor not ready");
      let result;
      if (provider === "AWS") result = await actor.testAwsConnection();
      else if (provider === "Azure")
        result = await actor.testAzureConnection();
      else result = await actor.testGcpConnection();
...
function useSetPollingInterval() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
function useEscalateToIncident() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (req) => {
...
function useSeedAndTestCorrelation() {
  const { actor } = useActor(createActor);
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async () => {
      if (!actor) throw new Error("Actor not ready");
      return actor.seedMockAlertsAndRunCorrelation();
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["correlatedIncidents"] });
...
export {
  useUpdateAlertStatus as A,
  useUpdateAlertOwner as B,
  useEnrichAlert as C,
  useNotificationLogs as D,
  useAlertRules as E,
  useSaveAlertRule as F,
  useDeleteAlertRule as G,
  useAcknowledgeNotification as H,
  useAuditLog as I,
  useFailedIngestions as J,
  useSeedAndTestCorrelation as K,
  useCorrelationStats as L,
  useUpdateCorrelatedIncidentStatus as M,
  useGetReports as N,
  useDeleteReport as O,
  useGetReportCsv as P,
  useGetReportEmailConfig as Q,
  useSaveReportEmailConfig as R,
  useGenerateReport as S,
  usePipelineHealth as T,
  useGlobalSearch as U,
  useAlertsForCorrelation as a,
  useNormalizedAlerts as b,
  createLucideIcon as c,
  useProviderStates as d,
  useBlockIp as e,
  useIsolateResource as f,
  useRevokeIamCredentials as g,
  useDisableAzureAdAccount as h,
  useForceGcpIamReview as i,
  useEscalateToIncident as j,
  useAssets as k,
  useComplianceStatus as l,
  useSaveAwsCredentials as m,
  useTestConnection as n,
  useSetPollingInterval as o,
  useSaveAzureCredentials as p,
  useSaveGcpCredentials as q,
  useGetEnrichmentKeys as r,
  useSaveEnrichmentKeys as s,
  useCredentialHealth as t,
  useCorrelatedIncidents as u,
  useRawFindings as v,
  useExportComplianceCsv as w,
  useExportCompliancePdf as x,
  useAssetById as y,
  useAssetFindings as z
};
