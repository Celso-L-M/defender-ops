import { r as reactExports, j as jsxRuntimeExports, R as React, g as useInternetIdentity, h as useRouterState, f as Link, i as useQueryClient } from "./index-gvVWhVUu.js";
import { c as createLucideIcon, T as usePipelineHealth, U as useGlobalSearch, b as useNormalizedAlerts } from "./use-backend--xAfAcuU.js";
...
function Layout({ children }) {
  ...
  const activeLabel = ((_a = navLinks.find(
    (l) => l.to === "/" ? pathname === "/" : pathname.startsWith(l.to)
  )) == null ? void 0 : _a.label) ?? (pathname.startsWith("/failed-ingestions") ? "Failed Ingestions" : pathname.startsWith("/assets/") ? "Asset Inventory" : "Overview");
