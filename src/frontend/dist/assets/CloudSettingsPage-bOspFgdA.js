import { r as reactExports, j as jsxRuntimeExports, R as React } from "./index-UYuukFCx.js";
import { B as Button } from "./button-D2D8gyAf.js";
import { I as Input } from "./input-jLaFAQlF.js";
import { P as Primitive, L as Label } from "./label-Dvz7D0Cb.js";
import { c as cn } from "./utils-CH5NUVML.js";
import { u as ue } from "./index-YNBEh2fO.js";
import { L as Layout, R as RefreshCw, C as CircleX } from "./Layout-BvE-Qw_4.js";
import { P as ProviderIcon } from "./ProviderIcon-B7LnSr-K.js";
import { S as StatusBadge } from "./StatusBadge-Q4VJwU4u.js";
import { c as createLucideIcon, u as useProviderStates, a as useSaveAwsCredentials, b as useTestConnection, d as useSetPollingInterval, e as useSaveAzureCredentials, f as useSaveGcpCredentials, g as useGetEnrichmentKeys, h as useSaveEnrichmentKeys, i as useGetWebhookSecretStatus, j as useSaveWebhookSecret, k as useCredentialHealth } from "./use-backend-BAJo2v8R.js";
import { L as LoaderCircle } from "./loader-circle-BMuv87qJ.js";
import { E as Eye } from "./eye-Bxk449PV.js";
...
function formatExpiryTime(expiryNs) {
  if (!expiryNs) return "";
  const expiryMs = Number(expiryNs / 1000000n);
...
function CredentialHealthBadge({
  ...
  if (health.__kind__ === "Valid") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded px-2 py-0.5 text-[11px] font-mono font-semibold bg-green-950/50 text-emerald-400 border border-emerald-700/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 11 }),
        "Valid"
      ] }),
      expiryNs && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-muted-foreground", children: formatExpiryTime(expiryNs) })
    ] });
  }
  if (health.__kind__ === "Authenticating") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded px-2 py-0.5 text-[11px] font-mono font-semibold bg-muted/40 text-muted-foreground border border-border", children: [
  ...
  if (health.__kind__ === "ExpiringSoon") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded px-2 py-0.5 text-[11px] font-mono font-semibold bg-warning/15 text-warning border border-warning/40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 11 }),
        "Expiring Soon"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-warning", children: health._0 })
    ] });
  }
  if (health.__kind__ === "Expired") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded px-2 py-0.5 text-[11px] font-mono font-semibold bg-destructive/15 text-destructive border border-destructive/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldOff, { size: 11 }),
      "Expired"
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded px-2 py-0.5 text-[11px] font-mono font-semibold bg-destructive/15 text-destructive border border-destructive/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 11 }),
      "Error"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] text-destructive mt-0.5", children: health._0 })
  ] });
}
function ProviderHealthBadge({ provider }) {
  const { data: healthList, isLoading } = useCredentialHealth();
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 rounded px-2 py-0.5 text-[11px] font-mono bg-muted/40 text-muted-foreground border border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 11, className: "animate-spin" }),
      "Checking..."
    ] });
  }
  const entry = healthList == null ? void 0 : healthList.find((h) => h.provider === provider);
  if (!entry) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CredentialHealthBadge, { health: entry.health, expiryNs: entry.expiryNs });
}
...
function pollingStatusToConnection(state) {
...
function TestResult({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `flex items-center gap-1.5 text-xs mt-2 ${success ? "text-[oklch(var(--success))]" : "text-destructive"}`,
      children: [
        success ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 13 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { size: 13 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: message })
      ]
    }
  );
}
function PollingSelect({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "select",
    {
      ...
      children: INTERVALS.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: i.value, children: i.label }, i.value))
    }
  );
}
function StatusBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: providers.map((p) => {
        const s = states == null ? void 0 : states.find((x) => x.provider === p);
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-semibold text-foreground", children: p })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-1", children: [
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: connStatus }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-muted-foreground", children: s ? formatTs(s.lastSuccessfulPoll) : "—" })
              ] })
            ]
          },
          p
    ...
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderIcon, { provider }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBadge, { status: connStatus }),
          (state == null ? void 0 : state.lastSuccessfulPoll) && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[11px] text-muted-foreground", children: [
            "Last sync: ",
            formatTs(state.lastSuccessfulPoll)
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
...
function AwsForm({ state }) {
  ...
  const {
    ...
    defaultValues: { interval: (state == null ? void 0 : state.interval) ?? "FifteenMin" }
  });
  ...
  const onSave = handleSubmit(async (vals) => {
    try {
      await save.mutateAsync({
        ...
        ...vals.externalId.trim() ? { externalId: vals.externalId.trim() } : {},
      ...
      ue.success("AWS credentials saved");
    } catch {
      ue.error("Failed to save AWS credentials");
    }
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: "Credential Status:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderHealthBadge, { provider: "AWS" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_a = errors.roleArn) == null ? void 0 : _a.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-1", children: "Comma-separated list" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  test.isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 13, className: "animate-spin mr-1.5" }),
                  "Test Connection"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                className: "min-w-[140px]",
                children: [
                  save.isPending && /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 13, className: "animate-spin mr-1.5" }),
                  "Save Credentials"
                ]
              }
            )
          ...
          test.isError && /* @__PURE__ */ jsxRuntimeExports.jsx(TestResult, { success: false, message: "Connection test failed" })
        ] })
      ]
    }
  );
}
function AzureForm({ state }) {
  var _a, _b, _c;
  ...
  const onSave = handleSubmit(async (vals) => {
    try {
      ...
      ue.success("Azure credentials saved");
    } catch {
      ue.error("Failed to save Azure credentials");
    }
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: "Credential Status:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderHealthBadge, { provider: "Azure" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_a = errors.clientId) == null ? void 0 : _a.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_b = errors.tenantId) == null ? void 0 : _b.message })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_c = errors.clientSecret) == null ? void 0 : _c.message })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function GcpForm({ state }) {
  ...
  const onSave = handleSubmit(async (vals) => {
    try {
      ...
      ue.success("GCP credentials saved");
    } catch {
      ue.error("Failed to save GCP credentials");
    }
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: "Credential Status:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderHealthBadge, { provider: "GCP" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Label,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { message: (_a = errors.serviceAccountJson) == null ? void 0 : _a.message })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function CloudSettingsPage() {
  ...
  const getState = (p) => states == null ? void 0 : states.find((s) => s.provider === p);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "settings.page", className: "space-y-6 max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Configure credentials for each cloud provider" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        RefreshCw,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderSection, { provider: "AWS", state: getState("AWS"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AwsForm, { state: getState("AWS") }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderSection, { provider: "Azure", state: getState("Azure"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AzureForm, { state: getState("Azure") }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderSection, { provider: "GCP", state: getState("GCP"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(GcpForm, { state: getState("GCP") }) }),
