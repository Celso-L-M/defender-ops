import { r as reactExports, j as jsxRuntimeExports, d as Link, L as LoadingSpinner } from "./index-CmSiIXAi.js";
import { L as Layout, a as ChevronRight, G as GitMerge } from "./Layout-DSnUumzH.js";
import { S as SeverityBadge } from "./SeverityBadge-D7ODbawO.js";
import { x as useCorrelationStats, y as useCorrelatedIncidents, z as useAlertsForCorrelation, A as useUpdateCorrelatedIncidentStatus } from "./use-backend-qlJEk42r.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "correlation.breakdown.section", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-md overflow-hidden", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      "div",
      {
        ...
        className: "py-8 text-center",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground", children: "No incidents detected yet" })
      }
