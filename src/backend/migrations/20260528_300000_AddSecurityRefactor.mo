...
/// Migration: AddSecurityRefactor
/// OldActor: exactly matches NewActor from 20260528_200000_AddCorrelationEngine.mo (25 fields).
/// NewActor: adds 2 new stable fields:
///   - processingOffset : Nat   (cursor for batched raw-finding processing, default 0)
///   - dirtyAssets      : [Text] (asset IDs needing risk recalculation, default [])
module {
  ...
  /// NewActor: adds processingOffset and dirtyAssets.
  type NewActor = {
    var awsCredentials               : ?AwsCredentials;
    var azureCredentials             : ?AzureCredentials;
    var gcpCredentials               : ?GcpCredentials;
