...
/// Migration: AddPerProviderAccessControl
/// OldActor: exactly matches NewActor from 20260528_500000.mo (33 fields).
/// NewActor: adds 1 new stable field:
///   - providerAssignments : Map.Map<Principal, [ProviderType]>
///     Maps each principal to the set of cloud providers they are assigned to.
///     Initialised empty; admins populate it via assignProviderAccess.
module {
  ...
  /// NewActor: adds 1 new stable field for per-provider access control.
  type NewActor = {
    var awsCredentials               : ?AwsCredentials;
    var azureCredentials             : ?AzureCredentials;
    var gcpCredentials               : ?GcpCredentials;
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      var providerAssignments          = Map.empty();
    };
  };
};
