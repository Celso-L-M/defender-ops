...
/// Migration: AddWebhookSecrets
/// OldActor: exactly matches NewActor from 20260528_400000_AddPhases5to7.mo (32 fields).
/// NewActor: adds 1 new stable field:
///   - webhookSecrets : { aws : ?Text; azure : ?Text; gcp : ?Text }
///     Write-only per-provider webhook secrets (never returned to the frontend).
module {
  ...
  /// NewActor: adds 1 new stable field for webhook secrets.
  type NewActor = {
    var awsCredentials               : ?AwsCredentials;
    var azureCredentials             : ?AzureCredentials;
    var gcpCredentials               : ?GcpCredentials;
  ...
  public func migration(old : OldActor) : NewActor {
    {
      ...
      var webhookSecrets               = { aws = null; azure = null; gcp = null };
    };
  };
};
